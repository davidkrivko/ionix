...
async function loadEvents() {
    ...
    const endpoint = `/api/schedules/${device_type}/?device_id=${device_id}`
    try {
...
async function deleteEvent(event_id) {
    try {
        const endpoint = `/api/schedules/${device_type}/delete/`;
...
async function saveNewEvent() {
    ...
    try {
    const endpoint = `/api/schedules/${device_type}/create/`;
    const csrfcookie = getCsrfCookieValue();
    let data = {};
