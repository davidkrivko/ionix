...
<div id="sidebar" class="flex flex-col w-64 h-full pt-6 pb-4 px-6 bg-white shadow-md">
  ...
  <div class="grid grid-cols-1 gap-y-8 mt-16 pl-2">
    <div class="cursor-pointer menu-item flex flex-row items-center gap-x-2" on:click={() => $selected_dashboard_component = 'rooms'}>
      <svg class="fill-current w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.68 10.66" x="0px" y="0px"><title>Asset 15</title><g data-name="Layer 2"><g data-name="Layer 1"><path d="M11.53,5.47,10.21,4.15h0l-4-4a.5.5,0,0,0-.71,0L.15,5.5a.5.5,0,0,0,0,.71.47.47,0,0,0,.35.15.47.47,0,0,0,.35-.15l.5-.5v4.45a.5.5,0,0,0,.5.5H4.32V6.91a.42.42,0,0,1,.42-.42H7a.42.42,0,0,1,.42.42v3.75H9.86a.5.5,0,0,0,.5-.5V5.71l.47.47a.5.5,0,0,0,.7,0,.51.51,0,0,0,.15-.36A.5.5,0,0,0,11.53,5.47Z"></path></g></g></svg>
      My rooms
    </div>
    <div on:click={() => $selected_dashboard_component = 'access'}
    ...
    <div on:click={() => $selected_dashboard_component = 'settings'}
    class="cursor-pointer menu-item flex flex-row items-center gap-x-2">
    ...
    <div on:click={() => $selected_dashboard_component = 'stats'}
      class="cursor-pointer menu-item flex flex-row items-center gap-x-2">
    ...
    <div on:click={() => $selected_dashboard_component = 'support'}
      class="cursor-pointer menu-item flex flex-row items-center gap-x-2">
